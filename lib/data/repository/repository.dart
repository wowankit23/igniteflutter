...
import 'package:ignitesolution/data/response/book_response.dart';
import 'package:ignitesolution/data/service/book_service.dart';
import 'package:ignitesolution/data/util/network_mapper.dart';
import 'package:ignitesolution/domain/entity/book.dart';
import 'package:ignitesolution/domain/entity/book_data.dart';
import 'package:ignitesolution/domain/utils/mapper.dart';
...
class RepositoryImpl implements Repository {
  ...
  final Mapper<Book, BookResult> _networkMapper = NetworkMapper() as Mapper<Book, BookResult>;
