...
import 'package:flutter_bloc/flutter_bloc.dart';
import 'package:ignitesolution/presentation/bloc/book_bloc.dart';
import 'package:ignitesolution/presentation/theme/colors.dart';
import 'package:ignitesolution/presentation/widgets/bottom_loader.dart';
import 'package:ignitesolution/presentation/widgets/buttons/back_button.dart';
import 'package:ignitesolution/presentation/widgets/book.dart';
import 'package:ignitesolution/presentation/widgets/search_bar.dart';
                ...
                return Container(
                  ...
                  child: GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return index >= state.books.length ? BottomLoader() : Book(book:state.books.elementAt(index));
                    },
                  ),
                );
              default:
